...
#ifndef __WordGame__Texture__
#define __WordGame__Texture__
...
namespace Fakhir
{
    ...
    public:
         ...
         */
        bool    SetTexture(GLuint textureID, int width, int height, bool hasAlpla = true);
...
#endif /* defined(__WordGame__Texture__) */
